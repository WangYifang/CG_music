...
AudioVisualizer.prototype.initialize = function () {
    ...
    // this.renderer.setClearColor(0xc3d7df, 1);
...
//wyf: load 3D models
AudioVisualizer.prototype.loadModel = function () {
    // loadModel("robot/model.obj");
    filename = "robot/model.obj";
    var loader = new THREE.OBJLoader();
    console.log("1-this.scene: ", this.scene);

    // 加载一个资源
    loader.load("model/robot/model.obj", function(object) {
        console.log("2-this.scene: ", this.scene);
